...
class CustomContainerRegister extends StatefulWidget {
  const CustomContainerRegister({super.key});

  @override
  State<CustomContainerRegister> createState() =>
      _CustomContainerRegisterState();
}

class _CustomContainerRegisterState extends State<CustomContainerRegister>
  ...
  void initState() {
    ...
    // Title animation (looping fade + scale)
    ...
    // Subtitle animation (looping fade + scale)
