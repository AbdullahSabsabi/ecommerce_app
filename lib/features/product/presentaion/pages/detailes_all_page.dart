...
class AllProductDetailPage extends StatefulWidget {
  Product product;
  final int productId;
  ...
  @override
  State<AllProductDetailPage> createState() => _AllProductDetailPage();
}

class _AllProductDetailPage extends State<AllProductDetailPage> {
  @override
