        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              await context.read<OrderCubit>().getOrdersByUser(order.user.id);
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'طريقة الدفع: ${paymentMethodText(order.paymentMethod)}',
                    style: const TextStyle(fontSize: 16),
                  ),
                  const SizedBox(height: 4),
                  Text(
                    'المبلغ الإجمالي: ${order.totalAmount.toStringAsFixed(2)} ل.س',
                    style: const TextStyle(fontSize: 16),
                  ),

                  const SizedBox(height: 4),
                  Text(
                    'تاريخ الإنشاء: ${DateFormat('dd-MM-yyyy HH:mm').format(order.createdAt)}',
                    style: const TextStyle(fontSize: 14, color: Colors.black54),
                  ),
                  SizedBox(height: 4),
                  Text(
                    'تاريخ التحديث: ${DateFormat('dd-MM-yyyy HH:mm').format(order.updateAt)}',
                    style: const TextStyle(fontSize: 14, color: Colors.black54),
                  ),
                ],
              ),
            ...
            FutureBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                return Row(
                  children: [
                    if (false) // ✅ يظهر فقط إذا المستخدم أدمن
                      Expanded(
