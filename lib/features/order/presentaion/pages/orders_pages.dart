...
import 'package:clothesecommerce/features/order/presentaion/pages/all_orders_page.dart';
...
class _MyOrdersPageState extends State<MyOrdersPage> {
  ...
  void initState() {
    super.initState();
    context.read<OrderCubit>().getOrdersByUser(widget.currentUser.id);
  }
              ...
              ? FloatingActionButton(
                  ...
                  onPressed: () async {
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return AllOrdersPage(user: widget.currentUser);
                        },
                      ),
                    );
                    setState(() {
